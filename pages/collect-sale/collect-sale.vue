<template>
	<view>
			<nav-bar>
				<template slot="left">
					<view>
						<image @click="handleBack" src="../../static/back.png" style="width: 60rpx;height: 60rpx;" mode="widthFix"></image>
					</view>
				</template>
			...
			<collectCard :image="item.baseNft.url" :tag="item.baseNft.familyName" :nickname="item.baseNft.nickname" :bianhao="item.uuTag" :author="item.baseNft.author"></collectCard>
			
			<view class="bottom-fixed">
				<input @click="showPopup = true" type="text" placeholder="请输入寄售人编号或选择联系人">
